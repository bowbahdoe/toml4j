...
public class TomlToClassTest {
  ...
  public void should_convert_toml_primitives() throws Exception {
    ...
    TomlPrimitives values = toml.to(new ObjectMapper(), TomlPrimitives.class);
  ...
  public void should_convert_to_non_toml_primitives() throws Exception {
    ExtraPrimitives extraPrimitives = new Toml().read(file("should_convert_extra_primitives.toml")).to(new ObjectMapper(), ExtraPrimitives.class);
  ...
  public void should_convert_tables() throws Exception {
    ...
    TomlTables tomlTables = toml.to(new ObjectMapper(), TomlTables.class);
  ...
  public void should_ignore_keys_not_in_class() throws Exception {
    TomlPrimitives tomlPrimitives = new Toml().read("a=1\nstring=\"s\"").to(new ObjectMapper(), TomlPrimitives.class);
  ...
  public void should_convert_table_array() throws Exception {
    TomlTableArrays toml = new Toml().read(file("should_convert_table_array_to_class.toml")).to(new ObjectMapper(), TomlTableArrays.class);
  ...
  public void should_convert_fruit_table_array() throws Exception {
    FruitArray fruitArray = new Toml().read(file("fruit_table_array.toml")).to(new ObjectMapper(), FruitArray.class);
